...
export default async function handler(req, res) {
  ...
  try {
    ...
    const imageMetadata = JSON.stringify({
      ...
      keyvalues: { type: 'nft-image', project: 'zombie-mutant-nft' }
    });
    ...
    const metadata = {
      ...
      description: description || 'A zombie mutant NFT generated by AI from Farcaster profile picture.',
      image: imageIpfsUri,
      attributes: [
    ...
    const metadataResp = await fetch('https://api.pinata.cloud/pinning/pinJSONToIPFS', {
      ...
      body: JSON.stringify({
        ...
        pinataMetadata: {
          name: `${name || 'Zombie Mutant'} - Metadata`,
          keyvalues: { type: 'nft-metadata', project: 'zombie-mutant-nft' }
        }
      }),
    });
